<div class="container d-flex justify-content-between gap-4" style="width: 100%; height: 100%">
        ...
        @foreach ($usersCarts as $index => $userCart)
            ...
            <div class="card-product card-all-check d-flex justify-content-between px-4 align-items-center shadow-sm gap-4"
                ...
                <div class="d-flex flex-column justify-content-center align-items-center " style="width: 150px;">
                    ...
                    @endif
                    <span>
                        <input type="checkbox" class="btn-check btn-check-outlined" id="btn-check-outlined-{{ $userCart->id }}" autocomplete="off" wire:click="toggleRelatedProducts('{{ $userCart->id }}')" {{ $userCartId === $userCart->id ? 'checked' : '' }}>
                        <label class="btn rounded-0 mt-2 p-0" for="btn-check-outlined-{{ $userCart->id }}" style="width: 120px; height: 27px;">produk serupa</label><br>
                    </span>
                </div>
    ...
    <div class="d-flex flex-column align-items-start gap-2" style="width: 30%; height: 100%;">
        <div class="shadow-sm card-summary bg-light" style="width: 100%; height: 280px;">
            ...
            <div class="shadow-sm card-related-products card-summary bg-light {{ count($relatedProducts ?? []) > 0 ? 'show' : 'hide' }}" style="width: 100%; height: 590px;">
                                        ...
                                        <div class="card border position-relative shadow-sm rounded-0"
                                            ...
                                            <div class="card-body p-2">
                                                <div class="d-flex justify-content-between">
                                                    <strong
                                                        style="font-size: 10px;">{{ $product->name }}</strong>
                                                ...
                                                <div class="d-flex align-items-center gap-1 mt-1">
                                                    ...
                                                    <span
                                                        style="font-size: 10px;">{{ $product->rate }}</span>
