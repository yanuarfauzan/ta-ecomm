        ...
        <div class="main-content">
            <section class="section">
                <div class="section-header">
                    <div class="section-header-back">
                        <a href="{{ url('/operator') }}"><i class="fas fa-arrow-left"></i></a>
                    </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h4>Profile Operator</h4>
                </div>
                <div class="card-body col">
                    <div class="mb-3">
                        <label for="username" class="form-label">Username</label>
                        <input type="text" class="form-control @error('username') is-invalid @enderror"
                            id="username" name="username" value="{{ old('username', $user->username) }}" disabled>
                        @error('username')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('birtdate') is-invalid @enderror"
                            id="birtdate" name="birtdate" value="{{ old('birtdate', $user->birtdate) }}" disabled>
                        @error('birtdate')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    @foreach ($user->userAddresses as $index => $address)
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('recipient_name') is-invalid @enderror"
                                ...
                                value="{{ old('address.' . $index . '.recipient_name', $address->recipient_name) }}" disabled>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('address') is-invalid @enderror"
                                ...
                                value="{{ old('address.' . $index . '.address', $address->address) }}" disabled>
                            @error('address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('detail') is-invalid @enderror"
                                ...
                                value="{{ old('address.' . $index . '.detail', $address->detail) }}" disabled>
                            @error('detail')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('postal_code') is-invalid @enderror"
                                ...
                                value="{{ old('address.' . $index . '.postal_code', $address->postal_code) }}" disabled>
                            @error('postal_code')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('city') is-invalid @enderror"
                                ...
                                value="{{ old('address.' . $index . '.city', $address->city) }}" disabled>
                            @error('city')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('province') is-invalid @enderror"
                                ...
                                value="{{ old('address.' . $index . '.province', $address->province) }}" disabled>
                            @error('province')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
