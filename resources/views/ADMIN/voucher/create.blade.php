        ...
        <div class="card-body col">
            <form action="{{ url('/admin/store-voucher') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="file" class="form-control @error('voucher_icon') is-invalid @enderror" id="voucher_icon" name="voucher_icon">
                    @error('voucher_icon')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('requirement') is-invalid @enderror" id="requirement" name="requirement">
                    @error('requirement')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('discount_value') is-invalid @enderror" id="discount_value" name="discount_value" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control @error('expired_at') is-invalid @enderror" id="expired_at" name="expired_at" required>
                    @error('expired_at')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
